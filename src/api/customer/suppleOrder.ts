...
enum Api {
  ...
  ADD = '/add',
  UPDATE = '/updateSuppleState',
  CHECK = '/check',
  UPLOAD_FILE = '/uploadSuppleFile',
  EXPORT = '/exportCustomer',
  SEARCH = '/searchSuppleOrder',
...
export const updateApi = (params: { orderId: number; saleState: number; customerId: string }) =>
  defHttp.post(
