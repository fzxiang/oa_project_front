...
import { a4 as genMessage } from "./index.f575d9f0.js";
import { a$ as _extends, b0 as Pagination } from "./vendor.faf2de98.js";
var common = {
  okText: "\u786E\u8BA4",
  closeText: "\u5173\u95ED",
  cancelText: "\u53D6\u6D88",
...
var antdLocale = localeValues;
const modules = { "./zh-CN/common.ts": __glob_2_0, "./zh-CN/component.ts": __glob_2_1, "./zh-CN/layout.ts": __glob_2_2, "./zh-CN/sys.ts": __glob_2_3, "./zh-CN/routes/basic.ts": __glob_2_4, "./zh-CN/routes/dashboard.ts": __glob_2_5, "./zh-CN/routes/demo.ts": __glob_2_6 };
var zh_CN = {
  message: __spreadProps(__spreadValues({}, genMessage(modules, "zh-CN")), {
    antdLocale
  })
};
