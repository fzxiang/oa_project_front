...
import { a_ as defaultLocale } from "./vendor.faf2de98.js";
var common = {
  okText: "OK",
  closeText: "Close",
  cancelText: "Cancel",
...
const modules = { "./en/common.ts": __glob_2_0, "./en/component.ts": __glob_2_1, "./en/layout.ts": __glob_2_2, "./en/sys.ts": __glob_2_3, "./en/routes/basic.ts": __glob_2_4, "./en/routes/dashboard.ts": __glob_2_5, "./en/routes/demo.ts": __glob_2_6 };
var en = {
  message: __spreadProps(__spreadValues({}, genMessage(modules, "en")), {
    antdLocale: defaultLocale
  }),
  dateLocale: null,
  dateLocaleName: "en"
};
