...
import { c as useAppStore, x as isString, B as withInstall } from "./index.27fe703a.js";
import { u as useWindowSizeFn } from "./useWindowSizeFn.7703d3fa.js";
import { bY as commonjsGlobal, d as defineComponent, Q as ref, w as watch, a7 as nextTick, aq as watchEffect, b as unref, a6 as onMounted, an as onUnmounted, o as openBlock, R as createElementBlock, aw as useDebounceFn, O as computed, f as createVNode, cD as getDefaultExportFromCjs, c as createBlock } from "./vendor.faf2de98.js";
...
var MODE = /* @__PURE__ */ ((MODE2) => {
  MODE2["JSON"] = "application/json";
  MODE2["HTML"] = "htmlmixed";
  MODE2["JS"] = "javascript";
  return MODE2;
})(MODE || {});
var codemirror = "";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    watch(() => props.value, async (value) => {
      ...
      if (value !== oldValue) {
        editor == null ? void 0 : editor.setValue(value ? value : "");
      }
    }, { flush: "post" });
    watchEffect(() => {
      editor == null ? void 0 : editor.setOption("mode", props.mode);
    });
    ...
    function setTheme() {
      var _a;
      (_a = unref(editor)) == null ? void 0 : _a.setOption("theme", appStore.getDarkMode === "light" ? "idea" : "material-palenight");
    }
    function refresh() {
    ...
    async function init() {
      ...
      editor = CodeMirror(el.value, __spreadValues({
        value: "",
        mode: props.mode,
      ...
      editor == null ? void 0 : editor.setValue(props.value);
      setTheme();
      editor == null ? void 0 : editor.on("change", () => {
        emit("change", editor == null ? void 0 : editor.getValue());
      });
    }
    onMounted(async () => {
      await nextTick();
...
(function(module, exports) {
  !function(e, t) {
    ...
    return function() {
      var e = { 802: function(e2, t2, l2) {
        function o(e3, t3, l3, o2, n2, s2, a2, i2) {
          var c2, r2 = typeof e3 == "function" ? e3.options : e3;
          if (t3 && (r2.render = t3, r2.staticRenderFns = l3, r2._compiled = true), o2 && (r2.functional = true), s2 && (r2._scopeId = "data-v-" + s2), a2 ? (c2 = function(e4) {
            (e4 = e4 || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || typeof __VUE_SSR_CONTEXT__ == "undefined" || (e4 = __VUE_SSR_CONTEXT__), n2 && n2.call(this, e4), e4 && e4._registeredComponents && e4._registeredComponents.add(a2);
          }, r2._ssrRegister = c2) : n2 && (c2 = i2 ? function() {
            n2.call(this, (r2.functional ? this.parent : this).$root.$options.shadowRoot);
          } : n2), c2)
            if (r2.functional) {
              r2._injectStyles = c2;
              var h2 = r2.render;
              r2.render = function(e4, t4) {
                return c2.call(t4), h2(e4, t4);
              };
            } else {
              var d = r2.beforeCreate;
              r2.beforeCreate = d ? [].concat(d, c2) : [c2];
            }
          return { exports: e3, options: r2 };
        }
        l2.r(t2), l2.d(t2, { default: function() {
          return h;
        } });
        var n = o({ props: { data: { required: true, type: String }, collapsedOnClickBrackets: Boolean }, methods: { toggleBrackets(e3) {
          this.collapsedOnClickBrackets && this.$emit("click", e3);
        } } }, function() {
          var e3 = this, t3 = e3.$createElement;
          return (e3._self._c || t3)("span", { staticClass: "vjs-tree__brackets", on: { click: function(t4) {
            return t4.stopPropagation(), e3.toggleBrackets(t4);
          } } }, [e3._v("\n  " + e3._s(e3.data) + "\n")]);
        }, [], false, null, null, null).exports, s = o({ props: { checked: { type: Boolean, default: false }, isMultiple: Boolean }, data: () => ({ focus: false }), computed: { uiType() {
          ...
          var e3 = this, t3 = e3.$createElement, l3 = e3._self._c || t3;
          return l3("label", { class: ["vjs-check-controller", e3.checked ? "is-checked" : ""], on: { click: function(e4) {
            e4.stopPropagation();
          } } }, [l3("span", { class: "vjs-check-controller__inner is-" + e3.uiType }), e3._v(" "), e3.uiType === "checkbox" ? l3("input", { directives: [{ name: "model", rawName: "v-model", value: e3.model, expression: "model" }], class: "vjs-check-controller__original is-" + e3.uiType, attrs: { type: "checkbox" }, domProps: { checked: Array.isArray(e3.model) ? e3._i(e3.model, null) > -1 : e3.model }, on: { change: [function(t4) {
            var l4 = e3.model, o2 = t4.target, n2 = !!o2.checked;
            if (Array.isArray(l4)) {
              var s2 = e3._i(l4, null);
              o2.checked ? s2 < 0 && (e3.model = l4.concat([null])) : s2 > -1 && (e3.model = l4.slice(0, s2).concat(l4.slice(s2 + 1)));
            } else
              e3.model = n2;
          }, function(t4) {
            return e3.$emit("change", e3.model);
          }], focus: function(t4) {
            e3.focus = true;
          }, blur: function(t4) {
            e3.focus = false;
          } } }) : e3.uiType === "radio" ? l3("input", { directives: [{ name: "model", rawName: "v-model", value: e3.model, expression: "model" }], class: "vjs-check-controller__original is-" + e3.uiType, attrs: { type: "radio" }, domProps: { checked: e3._q(e3.model, null) }, on: { change: [function(t4) {
            e3.model = null;
          }, function(t4) {
            return e3.$emit("change", e3.model);
          }], focus: function(t4) {
            ...
            e3.focus = false;
          } } }) : l3("input", { directives: [{ name: "model", rawName: "v-model", value: e3.model, expression: "model" }], class: "vjs-check-controller__original is-" + e3.uiType, attrs: { type: e3.uiType }, domProps: { value: e3.model }, on: { change: function(t4) {
            return e3.$emit("change", e3.model);
          }, focus: function(t4) {
            e3.focus = true;
          }, blur: function(t4) {
            ...
            t4.target.composing || (e3.model = t4.target.value);
          } } })]);
        }, [], false, null, null, null);
        function a(e3) {
          return Object.prototype.toString.call(e3).slice(8, -1).toLowerCase();
        }
        function i(e3, t3 = "root", l3 = 0, { key: o2, index: n2, type: s2 = "content", showComma: c2 = false, length: r2 = 1 } = {}) {
          const h2 = a(e3);
          if (h2 === "array") {
            const n3 = e3.map((e4, o3, n4) => i(e4, `${t3}[${o3}]`, l3 + 1, { index: o3, showComma: o3 !== n4.length - 1, length: r2, type: s2 })).reduce((e4, t4) => e4.concat(t4), []);
            return [i("[", t3, l3, { key: o2, length: e3.length, type: "arrayStart" })[0]].concat(n3, i("]", t3, l3, { showComma: c2, length: e3.length, type: "arrayEnd" })[0]);
          }
          if (h2 === "object") {
            const a2 = Object.keys(e3), h3 = a2.map((o3, n3, a3) => i(e3[o3], o3.includes(".") ? `${t3}["${o3}"]` : `${t3}.${o3}`, l3 + 1, { key: o3, showComma: n3 !== a3.length - 1, length: r2, type: s2 })).reduce((e4, t4) => e4.concat(t4), []);
            return [i("{", t3, l3, { key: o2, index: n2, length: a2.length, type: "objectStart" })[0]].concat(h3, i("}", t3, l3, { showComma: c2, length: a2.length, type: "objectEnd" })[0]);
          }
          const d = Object.entries({ content: e3, level: l3, key: o2, index: n2, path: t3, showComma: c2, length: r2, type: s2 }).reduce((e4, [t4, l4]) => l4 !== void 0 ? __spreadProps(__spreadValues({}, e4), { [t4]: l4 }) : e4, {});
          return a(d) === "object" ? [d] : d;
        }
        var c = o({ components: { Brackets: n, CheckController: s.exports }, props: { node: { required: true, type: Object }, collapsed: Boolean, collapsedOnClickBrackets: Boolean, showDoubleQuotes: Boolean, showLength: Boolean, checked: Boolean, selectableType: { type: String, default: "" }, showSelectController: { type: Boolean, default: false }, showLine: { type: Boolean, default: true }, selectOnClickNode: { type: Boolean, default: true }, pathSelectable: { type: Function, default: () => true }, highlightSelectedNode: { type: Boolean, default: true }, customValueFormatter: { type: Function, default: null } }, computed: { valueClass() {
        ...
        } }, methods: { defaultFormatter(e3) {
          let t3 = e3 + "";
          return this.dataType === "string" && (t3 = `"${t3}"`), t3;
        }, valueFormatter(e3) {
          const t3 = this.customValueFormatter ? this.customValueFormatter(e3, this.node.key, this.node.path, this.defaultFormatter(e3)) : this.defaultFormatter(e3);
          return this.node.showComma ? t3 + "," : t3;
        }, onBracketsClick() {
          ...
          var e3 = this, t3 = e3.$createElement, l3 = e3._self._c || t3;
          return l3("div", { class: { "vjs-tree__node": true, "has-selector": e3.showSelectController, "is-highlight": e3.highlightSelectedNode && e3.checked }, on: { click: e3.onTreeNodeClick } }, [e3.showSelectController && e3.selectable && e3.node.type !== "objectEnd" && e3.node.type !== "arrayEnd" ? [l3("check-controller", { attrs: { "is-multiple": e3.isMultiple, checked: e3.checked }, on: { change: e3.onCheckedChange } })] : e3._e(), e3._v(" "), e3._l(e3.node.level, function(t4, o2) {
            return l3("div", { key: o2, class: { "vjs-tree__indent": true, "has-line": e3.showLine } });
          }), e3._v(" "), e3.node.key ? l3("span", { staticClass: "vjs-key" }, [e3._v(e3._s(e3.prettyKey) + ":")]) : e3._e(), e3._v(" "), l3("span", [e3.node.type !== "content" ? l3("brackets", { attrs: { data: e3.node.content, "collapsed-on-click-brackets": e3.collapsedOnClickBrackets }, on: { click: e3.onBracketsClick } }) : l3("span", { class: e3.valueClass, domProps: { innerHTML: e3._s(e3.valueFormatter(e3.node.content)) } }), e3._v(" "), e3.showLength && e3.collapsed ? l3("span", { staticClass: "vjs-comment" }, [e3._v(" // " + e3._s(e3.node.length) + " items ")]) : e3._e()], 1)], 2);
        }, [], false, null, null, null), r = o({ name: "VueJsonPretty", components: { TreeNode: c.exports }, props: { data: { type: [String, Number, Boolean, Array, Object], default: null }, deep: { type: Number, default: 1 / 0 }, deepCollapseChildren: { type: Boolean, default: false }, path: { type: String, default: "root" }, virtual: { type: Boolean, default: false }, itemHeight: { type: Number, default: 20 }, showLength: { type: Boolean, default: false }, showDoubleQuotes: { type: Boolean, default: true }, selectableType: { type: String, default: "" }, showSelectController: { type: Boolean, default: false }, showLine: { type: Boolean, default: true }, selectOnClickNode: { type: Boolean, default: true }, value: { type: [Array, String], default: () => "" }, pathSelectable: { type: Function, default: () => true }, highlightSelectedNode: { type: Boolean, default: true }, collapsedOnClickBrackets: { type: Boolean, default: true }, customValueFormatter: { type: Function, default: null }, virtualLines: { type: Number, default: 10 } }, data() {
          return { translateY: 0, visibleData: null, hiddenPaths: i(this.data, this.path).reduce((e3, t3) => {
            const l3 = this.deepCollapseChildren ? t3.level >= this.deep : t3.level === this.deep;
            return t3.type !== "objectStart" && t3.type !== "arrayStart" || !l3 ? e3 : __spreadProps(__spreadValues({}, e3), { [t3.path]: 1 });
          }, {}) };
        }, computed: { flatData() {
          let e3 = null;
          return i(this.data, this.path).reduce((t3, l3, o2) => {
            const n2 = __spreadProps(__spreadValues({}, l3), { id: o2 }), s2 = this.hiddenPaths[n2.path];
            if (e3 && e3.path === n2.path) {
              const l4 = e3.type === "objectStart", o3 = __spreadProps(__spreadValues(__spreadValues({}, e3), n2), { content: l4 ? "{...}" : "[...]", type: l4 ? "objectCollapsed" : "arrayCollapsed" });
              return e3 = null, t3.concat(o3);
            }
            return s2 && !e3 ? (e3 = n2, t3) : e3 ? t3 : t3.concat(n2);
          }, []);
        }, selectedPaths: { get() {
          return this.value && this.selectableType === "single" ? [this.value] : this.value || [];
        }, set(e3) {
          this.$emit("input", e3);
        } }, propsError() {
        ...
        } }, watch: { propsError: { handler(e3) {
          if (e3)
            throw new Error("[VueJsonPretty] " + e3);
        }, immediate: true }, flatData: { handler() {
          this.onTreeScroll();
        }, immediate: true } }, methods: { onTreeScroll() {
          if (this.virtual) {
            const e3 = this.virtualLines, t3 = this.$refs.tree && this.$refs.tree.scrollTop || 0, l3 = Math.floor(t3 / this.itemHeight);
            let o2 = l3 < 0 ? 0 : l3 + e3 > this.flatData.length ? this.flatData.length - e3 : l3;
            o2 < 0 && (o2 = 0);
            const n2 = o2 + e3;
            this.translateY = o2 * this.itemHeight, this.visibleData = this.flatData.filter((e4, t4) => t4 >= o2 && t4 < n2);
          } else
            this.visibleData = this.flatData;
        }, onSelectedChange({ path: e3 }) {
          const t3 = this.selectableType;
          if (t3 === "multiple") {
            const t4 = this.selectedPaths.findIndex((t5) => t5 === e3), l3 = [...this.selectedPaths];
            t4 !== -1 ? this.selectedPaths.splice(t4, 1) : this.selectedPaths.push(e3), this.$emit("change", this.selectedPaths, l3);
          } else if (t3 === "single" && this.selectedPaths !== e3) {
            const t4 = this.selectedPaths, l3 = e3;
            this.selectedPaths = l3, this.$emit("change", l3, t4);
          }
        }, onTreeNodeClick({ content: e3, path: t3 }) {
          this.$emit("click", t3, e3);
        }, onBracketsClick(e3, t3) {
          if (e3)
            this.hiddenPaths = __spreadProps(__spreadValues({}, this.hiddenPaths), { [t3]: 1 });
          else {
            const e4 = __spreadValues({}, this.hiddenPaths);
            delete e4[t3], this.hiddenPaths = e4;
          }
        } } }, function() {
          var e3 = this, t3 = e3.$createElement, l3 = e3._self._c || t3;
          return l3("div", { ref: "tree", class: { "vjs-tree": true, "is-virtual": e3.virtual }, on: { scroll: e3.onTreeScroll } }, [l3("div", { style: e3.virtual && { height: e3.flatData.length * e3.itemHeight + "px" } }, [l3("div", { style: e3.virtual && { transform: "translateY(" + e3.translateY + "px)" } }, e3._l(e3.visibleData, function(t4) {
            return l3("tree-node", { key: t4.id, attrs: { node: t4, collapsed: !!e3.hiddenPaths[t4.path], "custom-value-formatter": e3.customValueFormatter, "show-double-quotes": e3.showDoubleQuotes, "show-length": e3.showLength, "collapsed-on-click-brackets": e3.collapsedOnClickBrackets, checked: e3.selectedPaths.includes(t4.path), "selectable-type": e3.selectableType, "show-line": e3.showLine, "show-select-controller": e3.showSelectController, "select-on-click-node": e3.selectOnClickNode, "path-selectable": e3.pathSelectable, "highlight-selected-node": e3.highlightSelectedNode }, on: { "tree-node-click": e3.onTreeNodeClick, "brackets-click": e3.onBracketsClick, "selected-change": e3.onSelectedChange } });
          }), 1)])]);
        }, [], false, null, null, null).exports, h = Object.assign({}, r, { version: "1.8.2" });
      } }, t = {};
      function l(o) {
        if (t[o])
          return t[o].exports;
      ...
      return l.d = function(e2, t2) {
        for (var o in t2)
          l.o(t2, o) && !l.o(e2, o) && Object.defineProperty(e2, o, { enumerable: true, get: t2[o] });
      }, l.o = function(e2, t2) {
...
var VueJsonPretty = /* @__PURE__ */ getDefaultExportFromCjs(vueJsonPretty.exports);
var styles = "";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(VueJsonPretty), {
        path: "res",
        deep: 3,
        showLength: true,
        data: __props.data
...
const CodeEditor = withInstall(_sfc_main$1);
const JsonPreview = withInstall(_sfc_main);
export { CodeEditor as C, JsonPreview as J, MODE as M };
