...
import { getBasicColumns, getFormConfig, getBasicColumnsChild } from "./tableData.594f23f4.js";
import { s as searchApi, u as updateApi, a as updateAllApi, e as exportApi, b as uploadFileApi } from "./writer.bbe6a5b2.js";
...
/* empty css                 *//* empty css                 *//* empty css                 *//* empty css                  *//* empty css                 */import "./useForm.cd73db2a.js";
      ...
      try {
        ...
        if ((result == null ? void 0 : result.length) !== 0) {
          createErrorModal({
            title: "\u4EE5\u4E0B\u6536\u6B3E\u8D26\u53F7\u5165\u5E93\u672A\u6210\u529F",
            width: 680,
            content: () => h("div", result.map((item) => h(Tag, {
              color: "blue",
