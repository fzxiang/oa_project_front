import { d as defineComponent, b6 as Divider, bp as Space, Q as ref, b as unref, O as computed, r as resolveComponent, o as openBlock, c as createBlock, e as withCtx, f as createVNode, aa as mergeProps, aj as createTextVNode } from "./vendor.faf2de98.js";
/* empty css                 *//* empty css                 */import { B as BasicModal, a as useModalInner } from "./index.0e01c4d1.js";
import { B as BasicForm } from "./BasicForm.a9877c74.js";
import { u as useForm } from "./useForm.530809d4.js";
import { orderInfoForm, writerInfoForm } from "./tableData.f77fa488.js";
import { av as defHttp, q as useUserStore, _ as _export_sfc, F as useMessage } from "./index.b67cb216.js";
import { d as downloadByUrl } from "./download.15ce02e4.js";
const addOrderApi = (params) => defHttp.post({ url: "/addOrder", params }, { successMessageMode: "notification" });
const updateOrderApi = (params) => defHttp.post({ url: "/updateOrder", params }, { successMessageMode: "notification", errorMessageMode: "message" });
const checkOrderApi = (params) => defHttp.post({ url: "/checkOrder", params }, { successMessageMode: "notification", errorMessageMode: "message" });
const uploadOrderFileApi = (params) => defHttp.post({ url: "/uploadOrderFile", params, timeout: 600 * 1e3 }, { successMessageMode: "notification", errorMessageMode: "message" });
...
const checkWriterApi = (params) => defHttp.get({ url: "/checkWriter", params }, { successMessageMode: "notification", errorMessageMode: "message" });
const searchChildApi = (params) => defHttp.post({ url: "/getWritersOfOrder", params });
const updateApi = (params) => defHttp.post({ url: "/updateMyOrderState", params }, { successMessageMode: "notification", errorMessageMode: "message" });
const deleteOrderApi = (params) => defHttp.post({ url: "/delOrder", params }, { successMessageMode: "notification", errorMessageMode: "message" });
  ...
  setup(_, { emit }) {
    ...
    async function handleSubmit() {
      try {
        ...
        writer = writer.filter((item) => item.writerNum !== void 0);
        if (isUpdate.value) {
...
export { MyOrderModal as M, searchChildApi as a, updateApi as b, MyOrderModal$1 as c, deleteOrderApi as d, exportApi as e, searchOrderApi as s, uploadOrderFileApi as u };
